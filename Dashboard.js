...
const ctx = document.getElementById('GazChart');
...
Dial.prototype.createArrow = function() {
  ...
  arrow.setAttribute('fill', '#677483');
...
var containers = document.getElementsByClassName("humidity-chart");
